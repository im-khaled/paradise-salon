...
const Contact = () => {
    ...
    return (
        <div>
                ...
                <div className='mx-24 py-16 max-sm:mx-6'>
                    <div className='grid lg:grid-cols-2 gap-8 p-5 max-lg:grid-cols-1'>
                        ...
                        <div>
                            ...
                            <div className='mt-10 flex justify-start max-sm:block'>
                                <div className='border-2 border-l-4 ps-5 pe-12  py-2 rounded max-sm:mb-5 '>
                                ...
                                <div className='border-2 border-l-4 ps-5 pe-10  py-2 rounded ms-10 max-sm:mx-0'>
